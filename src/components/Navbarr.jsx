...
const Navbarr = () => {
	...
	const Menus1 = ["Music and Band", "Movies and Series", "Sports", "Persona","Drip & Doodle","Anime","Abstract","Comics","সংস্কৃতি"];
						...
						<div className="relative left-4 sm:right-0">
							...
							<div className="">
								...
								{open && (
									...
									>
										<ul>
											<li className="p-2 text-sm cursor-pointer rounded hover:bg-blue-100"><NavLink to='/Music_Band' exact>Music and Band</NavLink></li>
											<li className="p-2 text-sm cursor-pointer rounded hover:bg-blue-100"><NavLink to="/Movies_Series" exact>Movies and Series</NavLink></li>
											<li className="p-2 text-sm cursor-pointer rounded hover:bg-blue-100"><NavLink to="/Sports" exact>Sports</NavLink></li>
											<li className="p-2 text-sm cursor-pointer rounded hover:bg-blue-100"><NavLink to="/Persona" exact>Persona</NavLink></li>
											<li className="p-2 text-sm cursor-pointer rounded hover:bg-blue-100"><NavLink to="/Drip_Doodle" exact>Drip and Doodle</NavLink></li>
											<li className="p-2 text-sm cursor-pointer rounded hover:bg-blue-100"><NavLink to="/Anime" exact>Anime</NavLink></li>
											<li className="p-2 text-sm cursor-pointer rounded hover:bg-blue-100"><NavLink to="/Abstract" exact>Abstract</NavLink></li>
											<li className="p-2 text-sm cursor-pointer rounded hover:bg-blue-100"><NavLink to="/Comics" exact>Comics</NavLink></li>
											<li className="p-2 text-sm cursor-pointer rounded hover:bg-blue-100"><NavLink to="/Sanskriti" exact>সংস্কৃতি</NavLink></li>
										</ul>
									</div>
								)}
							</div>
